...
class GroundController extends Controller
{
    ...
    public function addGround(Request $request){
        $validator = Validator::make($request->all(),[
            'ground_name' => 'required|string|max:191',
        ...
        return $this->groundService->addGround($request->all());
    }

    // public function testing(Request $request){
    //     $pass = "123456";
    //     return Http::get('http://127.0.0.1:3333/testing',[
    //         'password' => $pass,
    //     ]);
    // }

    public function updateGroundInfo(Request $request){
        $validator = Validator::make($request->all(),[
        ...
        return $this->groundService->updateGroundInfo($request->all());
    }

    public function removeGround(Request $request){
        $validator = Validator::make($request->all(),[
            'ground_id' => 'required|exists:grounds,id',
        ],[
            'ground_id.required' => "Ground is required.",
        ...
        return $this->groundService->removeGround($request->all());
    }

    public function getGroundList(Request $request){
        return $this->groundService->getGroundList($request->all());
    }
